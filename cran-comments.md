...
* **Refinement Wrappers:** Added a `robust` parameter to `lagrange_forest`, `lagrange_mice`, and `lagrange_ranger` to allow user-controlled robust covariance projection.
